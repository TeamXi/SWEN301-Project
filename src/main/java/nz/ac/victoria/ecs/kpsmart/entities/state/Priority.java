...
import static nz.ac.victoria.ecs.kpsmart.entities.state.TransportMeans.Air;
import static nz.ac.victoria.ecs.kpsmart.entities.state.TransportMeans.Land;
import static nz.ac.victoria.ecs.kpsmart.entities.state.TransportMeans.Sea;
